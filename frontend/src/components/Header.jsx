...
export default function Header({ isLoggedIn, setIsLoggedIn, name, setName, setEmail, profilePic }) {
    const handleLogout = () => {
        setIsLoggedIn(false);
        setName('');
        setEmail('');
    ...
    return (
        <header className="relative flex flex-col justify-center items-center p-4 gap-10 bg-gray-900 h-80">
            ...
            <img className="relative z-10 max-w-48 cursor-pointer" src="./MainIcon.svg" alt="Main Icon" />
